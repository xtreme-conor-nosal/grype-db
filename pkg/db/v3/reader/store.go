...
func (b *Store) GetID() (*v3.ID, error) {
	var scanErr error
	total := 0
	var m model.IDModel
...
func (b *Store) GetVulnerability(namespace, name string) ([]v3.Vulnerability, error) {
	var scanErr error
...
func (b *Store) GetVulnerabilityMetadata(id, namespace string) (*v3.VulnerabilityMetadata, error) {
	total := 0
